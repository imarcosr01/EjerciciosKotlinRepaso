...
import com.prueba.ejercicio.ui.theme.EjercicioTheme
...
fun TutorialScreen(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        Text(
            text = "Jetpack Compose tutorial", // String del título
            fontSize = 24.sp, // Tamaño de fuente
            modifier = Modifier
                .padding(16.dp), // Padding por todos lados
        ...
        Text(
            ...
            modifier = Modifier
                .padding(start = 16.dp, end = 16.dp), // Padding solo en los lados
